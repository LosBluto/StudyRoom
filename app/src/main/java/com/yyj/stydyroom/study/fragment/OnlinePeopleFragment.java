...
import com.yyj.stydyroom.base.ui.ptr.PullToRefreshBase;
import com.yyj.stydyroom.base.ui.ptr.PullToRefreshListView;
...
import com.yyj.stydyroom.study.helper.SimpleCallback;
import com.yyj.stydyroom.study.helper.VideoListener;
import com.yyj.stydyroom.study.viewholder.OnlinePeopleViewHolder;
...
public class OnlinePeopleFragment extends TFragment implements TAdapterDelegate, VideoListener {
    ...
    private void getMembers(final MemberQueryType memberQueryType, final long time, int limit) {
        ChatRoomMemberCache.getInstance().fetchRoomMembers(roomId, memberQueryType, time, (LIMIT - limit),
                                                           new SimpleCallback<List<ChatRoomMember>>() {
                                                               ...
                                                               public void onResult(boolean success,
                                                                   ...
                                                                   if (success) {
                                                                       ...
                                                                       if (onlineText.getVisibility() == View.VISIBLE ||
                                                                       ...
                                                                       if (memberQueryType ==
                                                                           ...
                                                                           getMembers(MemberQueryType.GUEST, enterTime,
                                                                                      result.size());
                                                                       }
                                                                   }
                                                                   stopRefreshing();
    ...
    private static Comparator<OnlinePeopleAdapter.OnlinePeopleItem> comp = (lhs, rhs) -> {
        if (lhs == null) {
            return 1;
        }
        if (rhs == null) {
        ...
        return compMap.get(lhs.getChatRoomMember().getMemberType()) - compMap.get(
                rhs.getChatRoomMember().getMemberType());
    };
    ...
    public void onKickOutSuccess(String account) {
        ...
        adapter.notifyDataSetChanged();
        videoListener.onKickOutSuccess(account);
    }
    ...
    public static Object getViewHolderByIndex(PullToRefreshListView listView, int index) {
        ...
        int firstVisibleFeedPosition =
                refreshableView.getFirstVisiblePosition() - refreshableView.getHeaderViewsCount();
