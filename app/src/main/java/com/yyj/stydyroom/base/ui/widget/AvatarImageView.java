package com.yyj.stydyroom.base.ui.widget;
...
import com.yyj.stydyroom.study.session.image.ImageLoaderKit;
import com.yyj.stydyroom.views.data.MyCache;

public class AvatarImageView extends CircleImageView {

    public static final int DEFAULT_THUMB_SIZE = (int) MyCache.getContext().getResources().getDimension(R.dimen.avatar_max_size);
