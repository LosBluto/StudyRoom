...
public class EasyAlertDialogHelper {
    public static void popClearMessageConfirmDialog(final Activity activity, final OnClearMessageListener listener,
        ...
        final EasyAlertDialog dialog = createOkCancelDialog(activity, null, title,
    ...
    public static void showOneButtonDialog(Context mContext, int titleResId, int msgResId, int btnResId,
                                           boolean cancelable, final OnClickListener positiveListener) {
        showOneButtonDialog(mContext, getString(mContext, titleResId), getString(mContext, msgResId),
                            getString(mContext, btnResId), cancelable, positiveListener);
    }

    public static void showOneButtonDialog(Context mContext, CharSequence titleString, CharSequence msgString,
    ...
    public static EasyAlertDialog createOkCancelDialog(Context context, CharSequence title, CharSequence message,
                                                       boolean cancelable, final OnDialogActionListener listener) {
        return createOkCancelDialog(context, title, message, null, null, cancelable, listener);
    }
