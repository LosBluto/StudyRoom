package com.yyj.stydyroom.base.utils.util.media;
...
import com.yyj.stydyroom.base.utils.util.file.AttachmentStore;
import com.yyj.stydyroom.base.utils.util.file.FileUtil;
import com.yyj.stydyroom.base.utils.util.storage.StorageType;
...
public class ImageUtil {
    ...
    public static Bitmap getDefaultBitmapWhenGetFail() {
        try {
            return getBitmapImmutableCopy(MyCache.getContext().getResources(), R.drawable.nim_image_download_failed);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
...
//    }
    ...
    public static int[] getBoundWithLength(int maxSide, Object imageObject, boolean resizeToDefault) {
        ...
        if (String.class.isInstance(imageObject)) {
            ...
            bound = BitmapDecoder.decodeBound(MyCache.getContext().getResources(), (Integer) imageObject);
            width = bound[0];
            height = bound[1];
    ...
    public static Bitmap getBitmapFromDrawableRes(int res) {
        try {
            return getBitmapImmutableCopy(MyCache.getContext().getResources(), res);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
